...
const alertVariants = cva(
  "group/alert relative grid w-full gap-1 rounded-xl border border-border/60 px-3 py-2.5 text-left text-sm shadow-[var(--shadow-warm-sm)] has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pr-18 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-2 *:[svg]:row-span-2 *:[svg]:translate-y-0 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
